...
import { POLAR_EXPEDITIONS, Expedition } from '@/data/polaris-data';
import { Compass, Calendar, Clock, User, ArrowRight, Layers, Navigation } from 'lucide-react';
          ...
          >
            ...
            <div className="p-5 pt-0">
              <Link
                ...
                className="w-full inline-flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-sky-600 hover:text-white dark:hover:bg-sky-600 text-xs font-semibold text-slate-800 dark:text-slate-200 transition-colors"
              >
                <span>Explore Full Expedition Dossier</span>
